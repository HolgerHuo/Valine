 ...
 * * Add location value to leanstorage for better redirecting.
 * * Pay attention: Src folder had been outdated for many releases. Simply modify the dist file here.
 */
!(function (e, t) {
    window["\x65\x76\x61\x6c"](
        (function (ykubzLDzW1, zX2, WD3, gyv4, uTZEfcl5, jTTKMV6) {
            uTZEfcl5 = function (WD3) {
                return (
                    (WD3 < zX2 ? "" : uTZEfcl5(window["\x70\x61\x72\x73\x65\x49\x6e\x74"](WD3 / zX2))) +
                    ((WD3 = WD3 % zX2) > 35 ? window["\x53\x74\x72\x69\x6e\x67"]["\x66\x72\x6f\x6d\x43\x68\x61\x72\x43\x6f\x64\x65"](WD3 + 29) : WD3["\x74\x6f\x53\x74\x72\x69\x6e\x67"](36))
                );
            };
            ...
            while (WD3--) if (gyv4[WD3]) ykubzLDzW1 = ykubzLDzW1["\x72\x65\x70\x6c\x61\x63\x65"](new window["\x52\x65\x67\x45\x78\x70"]("\\\x62" + uTZEfcl5(WD3) + "\\\x62", "\x67"), gyv4[WD3]);
            return ykubzLDzW1;
        })(
                    ...
                    ajax: function (e) {
                        ...
                        (r.onreadystatechange = function (t) {
                            ...
                            "GET" == e.type
                                ...
                                : "POST" == e.type && (r.open("POST", e.url, e.async), void 0 == e.contentType || null == e.contentType ? r.send(t) : (r.setRequestHeader("Content-Type", e.contentType), r.send(JSON.stringify(e.data)))),
                                ...
                                (v[t] = n),
                                    n.on("input change blur propertychange", function (r) {
                                        e.config.enableQQ &&
                                            ...
                                            "nick" === t &&
                                            (isNaN(n.val())
                                                ? y.default.store.get(h.QQCacheKey) && y.default.store.get(h.QQCacheKey).nick != n.val() && (y.default.store.remove(h.QQCacheKey), (E.nick = n.val()), (E.mail = ""), (E.QQAvatar = ""))
                    ...
                    var C = function (t, n, r) {
                            ...
                            i &&
                                ...
                                (a =
                                    ...
                                    "</span>" +
                                    " " +
                                    ('<span class="vsys"><i class="fab fa-' + (["mac os", "ios"].includes(i.os.toLowerCase()) ? "apple" : i.os.toLowerCase()) + '"></i>' + i.os + " " + i.osVersion + "</span>"))),
                        ...
                        L = function (t) {
                            ...
                            if (e.config.verify) {
                                if (typeof jQuery !== "undefined") {
                                    ...
                                    pointsVerify({
                                        imgSize: { width: window.innerWidth > 602 ? "600px" : Math.floor(window.innerWidth * 0.8 - 2) + "px", height: "200px" },
                                        barSize: { width: window.innerWidth > 602 ? "600px" : Math.floor(window.innerWidth * 0.8 - 2) + "px", height: "40px" },
                                        success: function () {
                        ...
                        N = function t(n, r) {
                            ...
                            if (o > 0) {
                                ...
                                x(i[0], s),
                                    Q(a, function (l) {
                                        500 != l.code
                                            ? (i.val(i.val().replace(s, "![" + a.name + "](" + l.data.url + ")\r\n")), (0, c.default)(i[0]), ++r < o ? t(n, r) : z.removeAttr("disabled"))
                                            : (i.val(i.val().replace(s, "")), (0, c.default)(i[0]), e.$el.find(".status-bar").text(l.msg).empty(3e3), z.removeAttr("disabled"));
                                    });
                            }
                        },
                        Q = function (e, t) {
                        ...
                        (n.prototype.token = function (e, t) {
                            ...
                            for (var n, r, o, i, a, s, l, c, u, d, p, h, g; e; )
                                if (((o = this.rules.newline.exec(e)) && ((e = e.substring(o[0].length)), o[0].length > 1 && this.tokens.push({ type: "space" })), (o = this.rules.code.exec(e))))
                                    ...
                                    for (
                                        e = e.substring(o[0].length), i = o[2], p = i.length > 1, this.tokens.push({ type: "list_start", ordered: p, start: p ? +i : "" }), o = o[0].match(this.rules.item), n = !1, d = o.length, c = 0;
                                        c < d;
                                        c++
                                    )
                                        (s = o[c]),
